...
namespace Veldrid.Sdl2
{
    public static unsafe partial class Sdl2Native
    {
        ...
        public delegate byte* SDL_GetClipboardText_t();
        public static SDL_GetClipboardText_t s_sdl_getClipboardText = LoadFunction<SDL_GetClipboardText_t>("SDL_GetClipboardText");
        public static string SDL_GetClipboardText() => Utilities.GetString(s_sdl_getClipboardText());

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int SDL_SetClipboardText_t(byte* text);
        public static SDL_SetClipboardText_t s_sdl_setClipboardText = LoadFunction<SDL_SetClipboardText_t>("SDL_SetClipboardText");
