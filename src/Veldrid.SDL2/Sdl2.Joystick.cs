...
namespace Veldrid.Sdl2
{
    ...
    public static unsafe partial class Sdl2Native
    {
        ...
        public delegate int SDL_NumJoysticks_t();
        public static SDL_NumJoysticks_t s_sdl_numJoysticks = LoadFunction<SDL_NumJoysticks_t>("SDL_NumJoysticks");
        /// <summary>
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int SDL_JoystickInstanceID_t(SDL_Joystick joystick);
        public static SDL_JoystickInstanceID_t s_sdl_joystickInstanceID = Sdl2Native.LoadFunction<SDL_JoystickInstanceID_t>("SDL_JoystickInstanceID");
        /// <summary>
